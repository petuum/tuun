"""
Code for model-based designers.
"""
...
class AcqOptDesigner:
    """
    Class to produce a design via acquisition function optimization.
    """
    ...
    def __init__(
        ...
        params : Namespace_or_dict
            Namespace or dict of additional parameters for the designer.
        verbose : bool
    ...
    def set_params(self, params):
        """Set self.params, the parameters for the designer."""
    ...
    def set_model(self, model):
        """Set self.model, the model used by the designer."""
        self.model = model
